...
import iconAnimation from '../../trophy.json';
...
export const CongratulationDialog = ({ isOpen, handleClose }: ModalProps) => {
  return (
    <div>
      <Modal open={isOpen} onClose={handleClose} className='flex items-center justify-center'>
        <div className='bg-white p-10 rounded-lg flex flex-col  max-w-[538px] w-full overflow-hidden'>
          ...
          <h2 className='text-[30px] leading-[30px] font-bold mb-6 text-center text-orange-600'>Congratulations!</h2>
          <p className='mb-[56px] text-[16px] text-center'>
            Congratulations, your company registration request has been successfully submitted. Our managers will review
